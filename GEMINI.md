...
### 400行ファイル上限とリファクタリング義務

- すべての Rust ソースファイル (`.rs`) は **400行以下（理想 200〜300行）** に収めること。
- 400行を超過したファイルは、新機能追加よりも優先して機能別サブモジュールへの分割を行うこと。
- 基本開発規範および禁止事項は [AGENTS.md](file:///a:/Project/OpenFallout3/AGENTS.md) を SSOT として完全遵守すること。
