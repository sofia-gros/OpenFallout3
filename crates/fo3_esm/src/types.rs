...
pub const REC_IDLE: FourCC = FourCC(*b"IDLE");
...
pub const SUB_ANAM: FourCC = FourCC(*b"ANAM");
pub const SUB_IDLA: FourCC = FourCC(*b"IDLA");
pub const SUB_IDLC: FourCC = FourCC(*b"IDLC");
pub const SUB_IDLT: FourCC = FourCC(*b"IDLT");
pub const SUB_IDLF: FourCC = FourCC(*b"IDLF");
...
pub const SUB_PKID: FourCC = FourCC(*b"PKID");
...
pub const SUB_QSTI: FourCC = FourCC(*b"QSTI");
